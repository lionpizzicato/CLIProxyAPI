...
import (
	...
	"github.com/lionpizzicato/CLIProxyAPI/v6/internal/access"
	managementHandlers "github.com/lionpizzicato/CLIProxyAPI/v6/internal/api/handlers/management"
	"github.com/lionpizzicato/CLIProxyAPI/v6/internal/api/middleware"
	"github.com/lionpizzicato/CLIProxyAPI/v6/internal/api/modules"
	ampmodule "github.com/lionpizzicato/CLIProxyAPI/v6/internal/api/modules/amp"
	"github.com/lionpizzicato/CLIProxyAPI/v6/internal/config"
	"github.com/lionpizzicato/CLIProxyAPI/v6/internal/logging"
	"github.com/lionpizzicato/CLIProxyAPI/v6/internal/managementasset"
	"github.com/lionpizzicato/CLIProxyAPI/v6/internal/usage"
	"github.com/lionpizzicato/CLIProxyAPI/v6/internal/util"
	sdkaccess "github.com/lionpizzicato/CLIProxyAPI/v6/sdk/access"
	"github.com/lionpizzicato/CLIProxyAPI/v6/sdk/api/handlers"
	"github.com/lionpizzicato/CLIProxyAPI/v6/sdk/api/handlers/claude"
	"github.com/lionpizzicato/CLIProxyAPI/v6/sdk/api/handlers/gemini"
	"github.com/lionpizzicato/CLIProxyAPI/v6/sdk/api/handlers/openai"
	sdkAuth "github.com/lionpizzicato/CLIProxyAPI/v6/sdk/auth"
	"github.com/lionpizzicato/CLIProxyAPI/v6/sdk/cliproxy/auth"
...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/project-keepalive/enabled", s.mgmt.GetProjectKeepAliveEnabled)
		mgmt.PUT("/project-keepalive/enabled", s.mgmt.PutProjectKeepAliveEnabled)
		mgmt.PATCH("/project-keepalive/enabled", s.mgmt.PutProjectKeepAliveEnabled)
		mgmt.GET("/project-keepalive/url", s.mgmt.GetProjectKeepAliveURL)
		mgmt.PUT("/project-keepalive/url", s.mgmt.PutProjectKeepAliveURL)
		mgmt.PATCH("/project-keepalive/url", s.mgmt.PutProjectKeepAliveURL)
		mgmt.GET("/project-keepalive/interval-seconds", s.mgmt.GetProjectKeepAliveIntervalSeconds)
		mgmt.PUT("/project-keepalive/interval-seconds", s.mgmt.PutProjectKeepAliveIntervalSeconds)
		mgmt.PATCH("/project-keepalive/interval-seconds", s.mgmt.PutProjectKeepAliveIntervalSeconds)
		...
		mgmt.GET("/auth-files/tree", s.mgmt.GetAuthFileTree)
...
func (s *Server) serveManagementControlPanel(c *gin.Context) {
	...
	data, err := managementasset.LoadManagementHTML(s.configFilePath)
	if err != nil {
		if errors.Is(err, os.ErrNotExist) {
			c.AbortWithStatus(http.StatusNotFound)
			return
		}
		log.WithError(err).Error("failed to load management control panel asset")
